...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'my_hexapod_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sun/hexapod_5_ws/src/my_hexapod_control/${idir}'.  Ask the maintainer 'sun <sun@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sun/hexapod_5_ws/src/my_hexapod_control/devel/lib;/home/sun/catkin_ws/devel/lib;/opt/ros/indigo/lib)
